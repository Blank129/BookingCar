...
export default function VehicleSelector({ vehicles, selectedVehicle, onVehicleSelect, distance }: VehicleSelectorProps) {
  ...
  return (
    <div className="space-y-3 md:space-y-4">
      <h2 className="text-lg md:text-xl font-semibold text-gray-900">Chọn loại xe</h2>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 md:space-x-4">
                  ...
                  <div className="text-left">
                    <h3 className="font-semibold text-gray-900 text-base md:text-lg">{vehicle.name}</h3>
                    <p className="text-gray-600 text-sm md:text-base">{vehicle.description}</p>
