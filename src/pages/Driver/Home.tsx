...
export default function HomeDriver() {
  ...
  const [tripStatus, setTripStatus] = useState<'going_to_pickup' | 'arrived_pickup' | 'passenger_onboard' | 'completed'>('going_to_pickup');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">VnCar Driver</h1>
        ...
        {currentTrip && (
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6 border-l-4 border-blue-500">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">Chuyến đi hiện tại</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium">{currentTrip.passenger.name}</p>
                      <p className="text-sm text-gray-600">⭐ {currentTrip.passenger.rating}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{currentTrip.pickup.name}</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{currentTrip.destination.name}</p>
                      <p className="text-sm text-gray-600">{currentTrip.destination.address}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex justify-between border-t border-gray-200 pt-2">
                    ...
                    <span className="text-xl font-bold text-green-600">{formatPrice(currentTrip.fare)}</span>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPrice(earnings.today)}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPrice(earnings.week)}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPrice(earnings.month)}</p>
              </div>
              ...
              <div className="space-y-4">
                {!isOnline ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Bạn đang offline</h3>
                    <p className="text-gray-600">Bật chế độ online để nhận yêu cầu chuyến đi</p>
                  </div>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Chờ yêu cầu chuyến đi từ khách hàng</p>
                  </div>
                ) : (
                  tripRequests.map((request) => (
                    <div key={request.id} className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                          <p className="text-xl font-bold text-green-600">{formatPrice(request.fare)}</p>
                          <p className="text-sm text-gray-600">{request.distance} km</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 mb-4">
                        <div className="flex items-start space-x-3">
                          <div className="w-3 h-3 bg-green-500 rounded-full mt-2"></div>
                          <div>
                            <p className="font-medium text-gray-900">{request.pickup.name}</p>
                        ...
                        <div className="flex items-start space-x-3">
                          <div className="w-3 h-3 bg-red-500 rounded-full mt-2"></div>
                          <div>
                            <p className="font-medium text-gray-900">{request.destination.name}</p>
                            <p className="text-sm text-gray-600">{request.destination.address}</p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
                    ...
                    <p className="text-3xl font-bold">{formatPrice(earnings.today)}</p>
                    <p className="text-green-100 text-sm mt-2">+12% so với hôm qua</p>
                  </div>
                  
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
                    <h3 className="text-lg font-medium mb-2">Tuần này</h3>
                    <p className="text-3xl font-bold">{formatPrice(earnings.week)}</p>
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
                    ...
                    <p className="text-3xl font-bold">{formatPrice(earnings.month)}</p>
                    <p className="text-purple-100 text-sm mt-2">+15% so với tháng trước</p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-600">Giờ online hôm nay</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {mockTripHistory.map((trip) => (
                  <div key={trip.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-green-600">{formatPrice(trip.fare)}</p>
